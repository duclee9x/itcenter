...
| RELEASE-007      | Production TLS Ingress + Rate Limiting                    |       P0 | `CODE_COMPLETE` | `N/A`                | RELEASE-004                     | Caddy/API edge, direct Agent mTLS, limits and validation implemented; real staging edge verification remains.    |
