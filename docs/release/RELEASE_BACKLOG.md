...
| RELEASE-004      | Immutable Build / Staging / Promotion / Rollback Pipeline |       P0 | `NOT_STARTED`   | `READY`              | None                            | Deployment contract is fixed by RELEASE-004-R1; implementation remains.                                |
...
migration, promotion, and rollback contracts. RELEASE-004 is
`READY / NOT_STARTED`; runtime/pipeline implementation has not begun. Overall
readiness remains `BLOCKED_FOR_RC`.
