...
complete RPO/RTO closure remain pending. RELEASE-006 is `VERIFIED` after its
qualifying isolated Podman N/N-1 compatibility rehearsal. RELEASE-007 is
...
| RR-05 | DATA_MIGRATION_GAP       | High     | RELEASE-006 qualifying production-like prior-schema upgrade, lock/duration measurement, N-1 compatibility, fixture integrity and rollback rehearsal are evidenced.                       | No                                                                        |
...
| RR-07 | SECURITY_GAP             | Critical | RELEASE-007-R1 fixes certificate lifecycle, trusted-proxy, numeric rate/body/timeout and failure-policy decisions; implementation is complete, but staging edge evidence remains absent. | Yes                                                                       |
