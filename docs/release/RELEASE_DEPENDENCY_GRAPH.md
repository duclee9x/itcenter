...
| ---------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| RELEASE-001      | None                                                                                      | Foundational API security adapter. Current readiness is independently blocked by its unresolved contract decision. |
...
As of this graph’s creation:

- **READY:** RELEASE-002, RELEASE-003, RELEASE-004, RELEASE-005.
- **BLOCKED:** RELEASE-001 (`SECURITY_DECISION / SPEC_GAP`).
