...
- **Contract gap:** Before runtime work, complete [RELEASE-006-R1](items/RELEASE-006-R1_POSTGRESQL_MIGRATION_COMPATIBILITY_CONTRACT.md) with the exact N-1 artifact/fixture identity, four-cell compatibility matrix, migration timeout and lock policy, destructive/expand-contract classification, partial-failure/retry policy, representative rehearsal envelope, and evidence/approval requirements.
