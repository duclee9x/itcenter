...
GUEST_BACKUP_MOUNT=$temp/backup-host
BACKUP_MOUNT_FSTYPES=virtiofs,9p
LIMA_WORK_DIR=$temp/backup-work
BACKUP_AGE_RECIPIENT=age1testrecipient
BACKUP_ESCROW_AGE_IDENTITY_REF=NOT_APPLICABLE_TEST
BACKUP_ESCROW_AGENT_CA_REF=NOT_APPLICABLE_TEST
